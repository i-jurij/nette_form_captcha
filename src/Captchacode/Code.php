...
class Code implements \Stringable
{
    ...
    public function __construct(
        ...
        if ($lengthMin < 1 || $lengthMax > 20) {
            throw new \InvalidArgumentException('Allowed length parameter value from 1 to 20');
        }

        if ($lengthMax < $lengthMin) {
            throw new \InvalidArgumentException('The maximum length should not be less than the minimum');
        }
